...
function load_GLTF_Model() 
{
		...
		//modelPositionOffset.set(0, 25.6, -40);
                ...
                // settings for Tron LightCycle model
                //modelScale = 10.0;
                //modelPositionOffset.set(0, 25,-40);
...
function initSceneData() 
{
        ...
        console.log("Single Mesh Triangle count: " + total_number_of_triangles);
        console.log("Number of Meshes: " + total_number_of_triangles);
        console.log("Total Triangle count: " + total_number_of_triangles * total_number_of_triangles);
