...
//--------------------------------------------------------------------------------------------------------------
{
	...
	while (true)
		...
		if (popNextNodeOffStack == TRUE) 
			...
			GetBoxNodeData(objStackIDs[int(stackptr)], currentBoxNodeData0, currentBoxNodeData1);
                }
...
//--------------------------------------------------------------------------------------------------------------
{
	...
	while (true)
		...
		leafAABBVolume = (currentBoxNodeData0.w - currentBoxNodeData0.x) *
				 (currentBoxNodeData1.x - currentBoxNodeData0.y) *
				 (currentBoxNodeData1.y - currentBoxNodeData0.z);
